...
public class Catalog {
    public static void main(String[] args) {
        ...
        Category c1=new Category(1,"Priya", Arrays.asList(new Category(1,"Somi",null)));
        Category c2 =new Category(2,"Something",Arrays.asList(new Category(1,"ghbuyhb",null)));
        Category c3 =new Category(3,"Anything",Arrays.asList(new Category(2,"bharath",null)));
